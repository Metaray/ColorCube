...
namespace ColorCube
{
    ...
    {
        protected static VertexPositionNormalTexture[] PrepareColorsVertexes(Color[] colors)
        {
        ...
        public abstract VertexPositionNormalTexture[] ColorsToVertexes(Color[] colors);
